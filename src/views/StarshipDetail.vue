<template>
  <div class="starship-detail-scroller-container">
    ...
    <div id="scroller">
      <div>
        <article>
          <p><span class="title">Name:</span> {{ starship.name }}</p>
          <p><span class="title">Model:</span> {{ starship.model }}</p>
          <p>
            <span class="title">Manufacturer:</span> {{ starship.manufacturer }}
          </p>
        </article>
        <article>
          <p>
            <span class="title">Cost in Credits:</span>
            {{ starship.cost_in_credits }}
          </p>
          <p><span class="title">Length:</span> {{ starship.length }}</p>
          <p>
            <span class="title">Max Atmosphering Speed:</span>
            {{ starship.max_atmosphering_speed }}
          </p>
        </article>
        <article>
          <p><span class="title">Crew:</span> {{ starship.crew }}</p>
          <p>
            <span class="title">Passengers:</span> {{ starship.passengers }}
          </p>
          <p>
            <span class="title">Cargo Capacity:</span>
            {{ starship.cargo_capacity }}
          </p>
          <p>
            <span class="title">Consumables:</span> {{ starship.consumables }}
          </p>
        </article>
        <article>
          <p>
            <span class="title">Hyperdrive Rating:</span>
            {{ starship.hyperdrive_rating }}
          </p>
          <p><span class="title">MGLT:</span> {{ starship.mglt }}</p>
          <p>
            <span class="title">Starship Class:</span>
...
export default {
  ...
  methods: {
    async fetchSingleStarship(id) {
      const singleStarship = await getSingleStarship(id);
      this.starship = singleStarship;
    },
  },
  created() {
...
#intro {
  ...
  font-size: 200%;
  animation: intro 30s ease-out infinite;
}
